    ...
    $.getJSON(
        ...
        function(data){
            ...
            for(let i = 0; i < data.items.length; i++){
                ...
                view += '<li id="' + item.id + '" class="result-item" onclick="selectBook(this);">';
                ...
                view += '<a class="result-item__more btn btn--orange btn--link_orange" href="'+ item.volumeInfo.previewLink +'" target="_blank">もっと見る</a>';
                view += '</li>';
            }
            $('#content1').html(view);
        }
